...
Route::get('book-status', 'CustomerController@showBookingForm');
Route::get('bookVerify', 'CustomerController@printmeNow')->name('bookVerify');
...
Route::get('admin-edit', 'AdminController@showEditAdminForm');
Route::post('update-admin-info', 'AdminController@updateAdminInfo')->name('update-admin-info');
Route::get('admin-booking-form', 'AdminController@AllBookingForm');
Route::get('admin-profile', 'AdminController@profile');
Route::get('admin-status', 'AdminController@showstatus');
