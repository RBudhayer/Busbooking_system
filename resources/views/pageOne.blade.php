    ...
    <div id="carousel-slider" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="item active">						
                <img src="{{asset('Bus/img/7.jpg')}}" class="img-responsive" alt=""> 
                    ...
                    <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.9s">								
                        <form class="form-inline"> 
                            <div class="form-group">
                                    ...
                                    <button type="getnow" name="" class="btn btn-primary btn-lg" required="required"> 
                                        <a href="{{ url('/registration') }}">Booking Open</a>
...
<div class="container">
    <div class="text-center">
        <h3>Gallery</h3>
        <p>BUSES For Our Customer</p>
    </div>
    <div class="row">
        <figure class="effect-chico">						
            <div class="col-md-3 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.3s">
                
                <img src="{{asset('Bus/img/work/1.jpg') }}" class="img-responsive" alt="">
                </a>						
            </div>
        </figure>
        <figure class="effect-chico">
            <div class="col-md-3 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.3s">
                ...
                <img src="{{asset('Bus/img/work/2.jpg') }}" class="img-responsive" alt="">
                </a>
            </div>
        </figure>	
        <figure class="effect-chico">
            <div class="col-md-3 wow fadeInDown" data-wow-offset="0" data-wow-delay="0.3s">
                ...
                <img src="{{asset('Bus/img/work/3.jpg') }}" class="img-responsive" alt="">
                </a>
            </div>
        </figure>
        <figure class="effect-chico">
            <div class="col-md-3 wow fadeInDown" data-wow-offset="0" data-wow-delay="0.3s">
                ...
                <img src="{{asset('Bus/img/work/4.jpg') }}" class="img-responsive" alt="">
                </a>
            </div>	
        </figure>
    </div>
        ...
        <div class="row">
            <figure class="effect-chico">
                <div class="col-md-3 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.3s">
                    ...
                    <img src="{{asset('Bus/img/work/5.jpg') }}" class="img-responsive" alt="">
                    </a>
                </div>
            </figure>	
            <figure class="effect-chico">
                <div class="col-md-3 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.3s">
                    ...
                    <img src="{{asset('Bus/img/work/6.jpg') }}" class="img-responsive" alt="">
                    </a>
                </div>
            </figure>	
            <figure class="effect-chico">
                <div class="col-md-3 wow fadeInDown" data-wow-offset="0" data-wow-delay="0.3s">
                    ...
                    <img src="{{asset('Bus/img/work/7.jpg') }}" class="img-responsive" alt="">
                    </a>
                </div>
            </figure>	
            <figure class="effect-chico">
                <div class="col-md-3 wow fadeInDown" data-wow-offset="0" data-wow-delay="0.3s">
                    ...
                    <img src="{{asset('Bus/img/work/8.jpg') }}" class="img-responsive" alt="">
                    </a>
                </div>
            </figure>
        </div>
    ...
    <div class="pricing-area text-center">
        <div class="row">
            ...
            <div class="col-sm-4 plan price-three wow fadeInDown" data-wow-offset="0" data-wow-delay="0.9s">
                {{-- If you want to keep premium logo --}}
                <ul>
